...
import de.rki.mamodar.AuthenticationFacade;
import de.rki.mamodar.MamodarApplication;
import de.rki.mamodar.database.Project;
import de.rki.mamodar.database.ProjectRepository;
import de.rki.mamodar.database.Resource;
import de.rki.mamodar.database.ResourceRepository;
import de.rki.mamodar.database.User;
import de.rki.mamodar.database.UserRepository;
import de.rki.mamodar.database.Value;
import de.rki.mamodar.database.ValueRepository;
import de.rki.mamodar.database.search.ProjectSpecificationsBuilder;
import de.rki.mamodar.dto.ProjectDTO;
import de.rki.mamodar.dto.ResourceDTO;
import de.rki.mamodar.dto.ValueDTO;
import de.rki.mamodar.exception.ObjectNotFoundException;
...
public class ProjectController {
  ...
  /**
   * Gets a list of the projects and converts them to {@link ProjectDTO} for a {@link User}.
   *
  ...
  /**
   * Gets the {@link Resource}s for one project and converts them to {@link ResourceDTO}s.
   *
   * @param id the id
  ...
  /**
   * Gets the {@link Value}s for one project and converts them to {@link ValueDTO}s.
   *
   * @param id the id
