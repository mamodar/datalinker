...
import de.rki.datalinker.AuthenticationFacade;
...
import de.rki.datalinker.database.search.ProjectSpecificationsBuilder;
import de.rki.datalinker.dto.ProjectDTO;
import de.rki.datalinker.dto.ResourceDTO;
import de.rki.datalinker.dto.ValueDTO;
import de.rki.datalinker.exception.ObjectNotFoundException;
import de.rki.datalinker.external.rdmo.RdmoConverter;
...
public class ProjectController {
  ...
  /**
   * The autowired  {@link RdmoConverter}.
   */
  @Autowired
  RdmoConverter rdmoConverter;

  /**
   * The autowired  {@link de.rki.datalinker.AuthenticationFacade} to validate the authenticity of the calling user.
   */
  @Autowired
