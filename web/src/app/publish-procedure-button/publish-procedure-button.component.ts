...
@Component({
  selector: 'app-publish-procedure-button',
  templateUrl: './publish-procedure-button.component.html',
  styleUrls: ['./publish-procedure-button.component.css']
})
export class PublishProcedureButtonComponent implements OnInit {
